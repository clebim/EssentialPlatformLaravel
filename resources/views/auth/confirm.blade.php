...
<div class="d-flex flex-column-fluid flex-center align-items-center justify-content-center">
  ...
  <div>
      <div class="text-center mb-10 mb-lg-20">
        <h2 class="font-size-h1">Conta criada com sucesso</h2>
        <p class="text-muted font-weight-bold h3 mt-5 mb-10">Aguarde a aprovação de um superior para conseguir efetuar o login</p>
